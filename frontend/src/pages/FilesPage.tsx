...
export function FilesPage(): React.ReactElement {
  const defaultCriteria: CriteriaFields = { rows: 50, fileTypes: [""], dateCreated: "0", lastModifiedDate: "today" };

  const { setCriteria, results } = useEntityList({ defaultCriteria, fetchList: getFiles });
