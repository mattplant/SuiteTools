    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "concurrency", element: <ConcurrencySummaryPage /> },
          { path: "concurrencyDetail/:startDate/:endDate", element: <ConcurrencyDetailPage /> },
          {
          ...
          { path: "jobRun/:id", element: <JobRunPage />, loader: jobRunLoader },
          { path: "jobRuns", element: <JobRunsPage /> },
          { path: "logins", element: <LoginsPage /> },
          { path: "role/:id", element: <RolePage />, loader: roleLoader },
          { path: "roles", element: <RolesPage /> },
          { path: "script/:id", element: <ScriptPage />, loader: scriptLoader },
          { path: "scripts", element: <ScriptsPage /> },
          { path: "scriptLog/:id", element: <ScriptLogPage />, loader: scriptLogLoader },
          { path: "scriptLogs/:script?", element: <ScriptLogsPage /> },
          { path: "soapLogs", element: <SoapLogsPage /> },
          { path: "soapLog/:id", element: <SoapLogPage />, loader: soapLogLoader },
          { path: "settings", element: <SettingsPage />, loader: settingsLoader },
          { path: "token/:id", element: <TokenPage />, loader: tokenLoader },
          { path: "tokens", element: <TokensPage /> },
          { path: "user/:id", element: <UserPage />, loader: userLoader },
