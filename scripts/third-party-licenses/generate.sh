...
#
# See docs/guides/third-party-licenses.md for why --recursive is the right scope.
FOCUS_ARGS=()
...

{
  ...
  # entries covering those live in ./overrides; see docs/guides/third-party-licenses.md.
  shopt -s nullglob
