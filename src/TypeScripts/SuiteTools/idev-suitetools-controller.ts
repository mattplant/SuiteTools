...
export class SuiteToolsController {
  ...
  public getRequestHandler(): void {
    ...
    switch (action) {
      ...
      case 'employees':
        ...
        break;
      case 'employeeModal':
        this.renderEmployeeForm(RenderType.Modal, id);
        break;
      case 'employee':
        this.renderEmployeeForm(RenderType.Normal, id);
        break;
      case 'loginsEmployee':
  ...
  public renderApmConcurrencySummaryForm(days = 3): void {
    ...
    const concurrencySummaryUrl = this.stApp.stLib.stLibNs.stLibNsScript.buildScriptUrl(
      accountId,
      scriptId,
      deployId,
      params
   ...
   */
  public renderApmConcurrencyDetailForm(): void {
   ...
   */
  public renderApmScriptDetailForm(): void {
    ...
    const results = this.stApp.stModel.getScriptLogsViaSuiteQL(
      null,
      null,
      null,
      [scriptId],
    ...
    const resultsTemplate = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/results/scriptLogs.html'
    );
    const resultsValues = {};
  ...
  public renderFilesForm(): void {
    ...
    const bodyValues = {};
    bodyValues['fileModal'] = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/modals/wrapper/file.html'
    );
    bodyValues['scriptUrl'] = this.stApp.scriptUrl;
  ...
  public renderIntegrationsForm(): void {
    ...
    const resultsTemplate = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/results/integrations.html'
    );
    const resultsValues = {};
    resultsValues['scriptUrl'] = this.stApp.scriptUrl;
    resultsValues['tableData'] = this.stApp.stView.generateTableData(results);
  ...
  public renderIntegrationForm(renderType: RenderType, id: string): void {
    ...
    if (record) {
      ...
      if (renderType === RenderType.Normal) {
        ...
        bodyValues['tokenModal'] = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
          'views/partials/modals/wrapper/token.html'
        );
        bodyValues['userModal'] = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
          'views/partials/modals/wrapper/user.html'
        );
        ...
        const resultsTemplate = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
          'views/partials/results/tokens.html'
        );
        const resultsValues = {};
        resultsValues['scriptUrl'] = this.stApp.scriptUrl;
        resultsValues['tableData'] = this.stApp.stView.generateTableData(results);
  ...
  public renderRolesForm(): void {
    ...
    const bodyValues = {};
    bodyValues['roleModal'] = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/modals/wrapper/role.html'
    );
    bodyValues['integrationModal'] = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/modals/wrapper/integration.html'
    );
   ...
   */
  public renderUsersIntegrationForm(): void {
    ...
    resultsTemplate = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/results/usersIntegration.html'
    );
    const resultsValues = {};
    resultsValues['scriptUrl'] = this.stApp.scriptUrl;
    resultsValues['tableData'] = this.stApp.stView.generateTableData(results, true);
    ...
    const bodyValues = {};
    bodyValues['employeeModal'] = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/modals/wrapper/employee.html'
    );
    bodyValues['roleModal'] = this.stApp.stLib.stLibNs.stLibNsFile.getFileContents(
      'views/partials/modals/wrapper/role.html'
    );
   ...
   */
  public renderEmployeesForm(): void {
   ...
   * @param id - the internal ID of the record
   */
  public renderEmployeeForm(renderType: RenderType, id: string): void {
    log.debug({
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  private updateIntegrationsData(value: any): any {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  private initiateLastLogins(value: any): void {
