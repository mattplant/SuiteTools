...
export class SuiteToolsModel {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  public getScript(id: string): any {
   ...
   * @returns integration
   */
  public getIntegration(id: string): // eslint-disable-next-line @typescript-eslint/no-explicit-any
  any {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  public getTokenList(activeOnly = false): any[] {
   ...
   * @returns Token
   */
  public getToken(id: string): // eslint-disable-next-line @typescript-eslint/no-explicit-any
  any {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  public getRoleList(activeOnly = false): any[] {
   ...
   * @returns Role
   */
  public getRole(id: string): // eslint-disable-next-line @typescript-eslint/no-explicit-any
  any {
