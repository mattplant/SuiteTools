...
describe("SuiteToolsApiModelQuery", () => {
  describe("queryOne", () => {
    ...
    it("returns the first row on hit", () => {
      ...
      expect(queryOne([row, { id: 2, name: "b.pdf" }], "unused")).toEqual({ status: 200, data: row });
    });
